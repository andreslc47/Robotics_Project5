...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/robond/Robotics_Project5/src/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /home/robond/Robotics_Project5/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /home/robond/Robotics_Project5/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Robotics_Project5/src/slam_gmapping/gmapping/${idir}'.  Ask the maintainer 'ROS Orphaned Package Maintainers <ros-orphaned-packages@googlegroups.com>' to fix it.")
    endif()
