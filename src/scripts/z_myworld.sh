...
sleep 5 
xterm -e " source /opt/ros/kinetic/setup.bash ; source /home/robond/Robotics_Project5/devel/setup.bash ; rosrun map_server map_server /home/robond/Robotics_Project5/src/map/map_server/map.yaml " &
sleep 5 
