...
sleep 5 
xterm -e " source /opt/ros/kinetic/setup.bash ; source /home/robond/Robotics_Project5/devel/setup.bash ; rosrun map_server map_server /home/robond/Robotics_Project5/src/map/rtabmap/map.yaml " &
sleep 5
xterm -e " ./../../fix_gazebo_and_rviz_windows "
sleep 5
